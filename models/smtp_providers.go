			...
			Fields: []SMTPProviderField{
				{
					...
					Description: "Your Gmail email address (same as username)",
				},
				{
					Key:         "username",
					Label:       "Gmail Address",
				...
				},
				{
					...
					Type:        "password",
					Required:    true,
					Description: "Use an App Password, not your regular password",
				},
			},
		},
		{
			...
			Fields: []SMTPProviderField{
				{
					...
					Description: "Your Outlook email address (same as username)",
				},
				{
					Key:         "username",
					Label:       "Email Address",
					...
					Required:    true,
					Placeholder: "your-email@outlook.com",
					Description: "Your Outlook/Office 365 email",
				},
				{
					Key:         "password",
					Label:       "Password",
			...
			Fields: []SMTPProviderField{
				{
					...
					Description: "Your Yahoo email address (same as username)",
				},
				{
					Key:         "username",
					Label:       "Yahoo Email",
					...
					Required:    true,
					Placeholder: "your-email@yahoo.com",
					Description: "Your Yahoo email address",
				},
				{
					Key:         "password",
					Label:       "App Password",
					Type:        "password",
					Required:    true,
					Description: "Use an App Password for security",
				},
			},
		},
		{
			...
			Fields: []SMTPProviderField{
				{
					...
					Description: "Your Zoho email address (same as username)",
				},
				{
					Key:         "username",
					Label:       "Zoho Email",
					...
					Required:    true,
					Placeholder: "your-email@zoho.com",
					Description: "Your Zoho email address",
				},
				{
					Key:         "password",
					Label:       "Password",
					Type:        "password",
					Required:    true,
					Description: "Your Zoho account password",
				},
			},
		},
		{
			...
			Fields: []SMTPProviderField{
				{
					...
					Description: "Your full email address (same as username)",
				},
				{
					Key:         "username",
					Label:       "Email Address",
